...
function initApp() {
  ...
  const EXERCISE_CATALOG = [
    ...
    { id: 'deficit_hspu', name: 'Deficit HSPU', category: 'gymnastic', unit: 'reps', defaultReps: 3 },
    ...
    { id: 'toes_to_ring', name: 'Toes-to-Ring', category: 'gymnastic', unit: 'reps', defaultReps: 10 },
